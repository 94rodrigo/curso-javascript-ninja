...
var sudeste = ['São Paulo','Minas Gerais','Rio de Janeiro','Eepírito Santo'];
...
var nordeste = ['Bahia','Ceará','Alagoas','Maranhão','Rio Grande do Norte','Pará','Pernambuco','Piauí','Sergipe'];
